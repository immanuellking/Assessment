            ...
            <div className="flex gap-x-8">
              ...
              <div className="flex ">
                <div className="flex flex-col items-start px-8 border-l border-[#E8E8E8]">
                  ...
                  <h4 className="text-[28px] font-semibold text-black">100</h4>
                </div>
                <div className="flex flex-col items-start px-8 border-l border-[#E8E8E8]">
                ...
                <div className="flex flex-col items-start px-8 border-l border-[#E8E8E8]">
                  ...
                  <h4 className="text-[28px] font-semibold text-black">143</h4>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white p-6 flex justify-between">
            <div className="flex gap-x-2">
              <button className="w-[210px] h-[40px] border bg-[#d2d2d2] flex items-center justify-center gap-x-2 rounded-[8px]">
                <span className="text-base text-black">Table Search Query</span>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
          ...
          <div className="overflow-x-auto">
            <table className="table-auto border-collapse w-full text-sm text-left text-gray-700">
              <thead className="bg-gray-100">
                <tr>
                  <th className="border px-4 py-2">Customer Name/ID</th>
